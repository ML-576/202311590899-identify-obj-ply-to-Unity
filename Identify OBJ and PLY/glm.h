...
/* ============================================================
   修改说明(2026)：为使本文件能编译为 Unity 原生插件(无需OpenGL/MFC)，
   将 OpenGL 头文件包含改为条件编译。定义 NO_OPENGL_RENDER 宏时
   仅提供 OpenGL 数据类型定义，源代码其余内容保持不变。
   ============================================================ */
#if defined(NO_OPENGL_RENDER)
   /* 插件模式：只需要数据类型 */
#elif defined(_WIN32)
#include <windows.h>
#include <gl/gl.h>
#else
#define NO_OPENGL_RENDER 1
#endif
